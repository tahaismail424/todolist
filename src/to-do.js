...
taskList[0] = toDoItem('My first task', 
'I will do this task as tasks are meant to be done', '2020-12-31', 
prioList[2], projList[0].title);
...
function saveToDo (item) {
    ...
    let newTask = toDoItem(newData[0], newData[1], newData[2], 
        newData[3], newData[4]);
